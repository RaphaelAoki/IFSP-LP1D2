...
<div class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('https://mdbootstrap.com/img/Photos/Others/gradient2.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    ...
    <div class="container h-100 d-flex justify-content-center align-items-center">
        ...
        <div class="col-md-12 wow fadeIn mb-3">
            ...
            <h1 class="display-4 font-weight-bold mb-5 wow fadeInUp">Introducing HealthTrackr</h1>
            </li>
            <h5 class="mb-5 wow fadeInUp" data-wow-delay="0.2s">Your Personalized Exam and Medical Screening Companion</h5>
            <div class="wow fadeInUp" data-wow-delay="0.4s">
                <a href="sing-up" class="btn btn-purple btn-rounded"><i class="fas fa-user left"></i> Sign up!</a>
